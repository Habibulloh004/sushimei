...
func (h *Handler) List(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Fail(c, fiber.StatusInternalServerError, "failed to fetch categories", err.Error())
	}
...
func (h *Handler) GetByID(c *fiber.Ctx) error {
	id := c.Params("id")
	if id == "" {
		return response.Fail(c, fiber.StatusBadRequest, "missing category id", nil)
	}
	...
	if err != nil {
		...
		return response.Fail(c, statusCode, "failed to fetch category", err.Error())
	}
...
func (h *Handler) Create(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Fail(c, fiber.StatusBadRequest, "failed to create category", err.Error())
	}
...
func (h *Handler) Update(c *fiber.Ctx) error {
	...
	if err := h.service.Update(c.Context(), id, req); err != nil {
		...
		return response.Fail(c, statusCode, "failed to update category", err.Error())
	}
...
func (h *Handler) Delete(c *fiber.Ctx) error {
	...
	if err := h.service.Delete(c.Context(), id); err != nil {
		...
		return response.Fail(c, statusCode, "failed to delete category", err.Error())
	}
