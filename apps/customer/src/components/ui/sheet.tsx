  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background fixed z-[1001] flex flex-col gap-4 shadow-2xl transition-[transform,opacity] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform data-[state=closed]:opacity-0 data-[state=open]:opacity-100",
          side === "right" &&
